...
class TestModel(BaseModel):
    ...
    See the testLoss instruction for more details.
    """
    @staticmethod
    def modify_commandline_options(parser, is_train=True):
        ...
        The model can only be used during testLoss time. It requires '--dataset_mode single'.
    ...
    def optimize_parameters(self):
        """No optimization for testLoss model."""
        pass
